...
export class KeyframeAnimation {
    ...
    interpolateProperties(start, end, t) {
        const result = {};
        ...
        for (const key of allKeys) {
            ...
            if (startValue === undefined) {
                ...
                result[key] = startValue.map((val, index) => typeof val === 'number' && typeof endValue[index] === 'number' ?
...
export class AnimationEngine {
    ...
    animate(id, config, onUpdate, onComplete) {
    ...
    static slideInFromLeft(duration = 300) {
        return {
            duration,
            delay: 0,
            easing: 'ease-out',
    ...
    static slideInFromRight(duration = 300) {
        return {
            duration,
            delay: 0,
            easing: 'ease-out',
    ...
    static pulse(duration = 1000, repeat = -1) {
        return {
            duration,
            delay: 0,
            repeat,
